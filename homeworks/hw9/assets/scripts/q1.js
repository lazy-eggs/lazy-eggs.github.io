...
function redButtonClicked() {
    ...
    let redbtn = document.getElementById("q1-btn-red");
...
function grnButtonClicked() {
    let grnbtn = document.getElementById("q1-btn-green");
    grnbtn.onclick = function() {
        setBackgroundColor("#06D6A0");
    }
}

document.getElementById("q1-btn-green").onclick = grnButtonClicked;
...
function lbButtonClicked() {
    let lbbtn = document.getElementById("q1-btn-lightblue");
